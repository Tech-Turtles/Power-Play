...
public abstract class SwerveMotor {
    ...
    protected final Motors motorConfig;

    SwerveMotor(Motors motor) {
        this.motorConfig = motor;
    }
    ...
    public Motors getMotorConfig() {
        return motorConfig;
    }
    /**
     * Set the motor object for the module.
     */
    public abstract void setMotor(DcMotorEx m);
     ...
     * @return Motor object.
     */
    public abstract DcMotorEx getMotor();
}
